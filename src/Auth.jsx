...
async function tryBiometric(userId) {
  try {
    ...
    await navigator.credentials.create({
      publicKey:{
        challenge:ch,
        rp:{name:"FinPlay",id:window.location.hostname},
        user:{id:new TextEncoder().encode(userId),name:userId,displayName:"FinPlay"},
  ...
  return (
    <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",
      ...
      <div style={{textAlign:"center",marginBottom:22}}>
        ...
        <div style={{fontWeight:900,fontSize:30,color:C.text,letterSpacing:-1}}>FinPlay</div>
      ...
      <div style={{background:C.card,borderRadius:24,padding:26,width:"100%",maxWidth:390,
        ...
        {mode==="login"&&(
          <form onSubmit={handleLogin}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:10,margin:"6px 0"}}>
              ...
              <span style={{fontSize:11,color:C.textLt,fontWeight:600}}>o continúa con</span>
              <div style={{flex:1,height:1,background:C.border}}/>
            </div>
            <button type="button" onClick={handleGoogleAuth} disabled={loading}
              style={{width:"100%",padding:"12px",borderRadius:15,border:`1.5px solid ${C.border}`,
                background:"white",color:C.text,fontSize:14,fontWeight:700,cursor:"pointer",
                fontFamily:"'Nunito',sans-serif",display:"flex",alignItems:"center",
                justifyContent:"center",gap:10,boxShadow:"0 2px 8px rgba(0,0,0,0.1)",marginBottom:8}}>
        ...
        {mode==="register"&&step===1&&(
          <div>
            ...
            <div style={{display:"flex",alignItems:"center",gap:10,margin:"6px 0"}}>
              <div style={{flex:1,height:1,background:C.border}}/>
              <span style={{fontSize:11,color:C.textLt,fontWeight:600}}>o regístrate con</span>
              <div style={{flex:1,height:1,background:C.border}}/>
            </div>
            <button type="button" onClick={handleGoogleAuth} disabled={loading}
              style={{width:"100%",padding:"12px",borderRadius:15,border:`1.5px solid ${C.border}`,
        ...
        {mode==="register"&&step===2&&(
          <div>
            ...
            <div style={{fontSize:13,color:C.textMed,marginBottom:16,lineHeight:1.6}}>
              Necesitamos verificar tu edad para proteger a los usuarios menores de FinPlay.
            </div>
